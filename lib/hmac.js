...
/**
 * HMAC d'un nom de personne normalisé (casse / accents / ordre des mots ignorés).
 * Préfixe de domaine `name:` pour ne pas collisionner avec un code-barres.
 */
export function hashPersonNameKey(normalizedKey) {
  if (!normalizedKey) return null;
  return hashBarcode(`name:${normalizedKey}`);
}
